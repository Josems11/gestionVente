<%-- 
    Document   : impression_client
    Created on : 03 août. 2018, 10:11:58
    Author     : K-LynG
--%>
...
<html>
    <head>
        <title>Impression liste client</title>
    ...
    <body>
        <%
            ...
            File target = new File(application.getRealPath("print/Liste_client.jasper"));
