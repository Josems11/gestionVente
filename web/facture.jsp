<%-- 
    Document   : impression
    Created on : 02 août. 2018, 14:28:14
    Author     : K-LynG
--%>
...
<html>
    ...
    <body>
        <%
            ...
            File target = new File(application.getRealPath("print/Facture.jasper"));
            Map param = new HashMap();System.out.println("target reussi");
