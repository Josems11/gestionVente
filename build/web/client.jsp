          ...
          <div class="row purchace-popup">
            ...
            <div class="row">
                <div class="col-12 stretch-card">
                  <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="post" name="client">
                        <div class="form-group row">
                          <label for="exampleInputPassword2" class="col-sm-1 col-form-label">Nom</label>
                          <div class="col-sm-11">
                            <input type="text" class="form-control nom_cli" id="nom_cli" name="nom_cli" onblur="CtrlNom(client)">
                          </div>
                        </div>
                        <div class="form-group row">
                          <label for="exampleInputEmail2" class="col-sm-1 col-form-label">Prénom(s)</label>
                          <div class="col-sm-11">
                              <input type="text" class="form-control prenom_cli" id="prenom_cli" name="prenom_cli" onblur="CtrlPrenom(client)">
                          </div>
                        </div>
                        <div class="form-group row">
                          <label for="exampleInputPassword2" class="col-sm-1 col-form-label">CIN</label>
                          <div class="col-sm-11">
                              <input type="text" class="form-control cin_cli" id="cin_cli" name="cin_cli" data-inputmask='"mask": "999 999 999 999"' data-mask onblur="CtrlCIN(client)">
                          </div>
                        </div>
                        <div class="form-group row">
                          <label for="exampleInputEmail2" class="col-sm-1 col-form-label">Téléphone</label>
                          <div class="col-sm-11">
                              <input type="text" class="form-control tel_cli"  id="tel_cli" name="tel_cli" data-inputmask='"mask": "+261 39 99 999 99"' data-mask onblur="CtrlTel(client)">
                          </div>
                        </div>
                        <div class="form-group row">
                          <label for="exampleInputPassword2" class="col-sm-1 col-form-label">Adresse</label>
                          <div class="col-sm-11">
                              <textarea type="text" class="form-control adresse_cli"  id="adresse_cli" name="adresse_cli" onblur="CtrlAdresse(client)"></textarea>
                          </div>
                        </div>
...
<script>
  $(function () {
        $("#nom_cli").keyup(function(){
          AfficheBtnSave();
        });

        $("#prenom_cli").keyup(function(){
          AfficheBtnSave();
        });

        $("#cin_cli").keyup(function(){
          AfficheBtnSave();
        });

        $("#tel_cli").keyup(function(){
          AfficheBtnSave();
        });

        $("#adresse_cli").keyup(function(){
          AfficheBtnSave();
        });
    });
    
    function Remplissage(){
        if((!VerifieChamp($("#nom_cli"))) && (!VerifieChamp($("#prenom_cli"))) && (!VerifieChamp($("#cin_cli"))) && (!VerifieChamp($("#tel_cli"))) && (!VerifieChamp($("#adresse_cli")))){
            return true;
            }
        }
     ...
     $(document).ready(function(){
       ...
       function enlevement(elm) {
        ...
        $('#btn_save').on('click',function(){
            ...
            if (nom_cli === '' || prenom_cli=== '' || cin_cli === '' || tel_cli === '' || adresse_cli=== '') {
               swal("", "Veuillez remplir le champ vide", "error");
            } else{
            $.ajax({
                type : "POST",
                url  : "insert_client.jsp",
                dataType : "JSON",
                data : {nom_cli:nom_cli, prenom_cli:prenom_cli,cin_cli:cin_cli , tel_cli:tel_cli, adresse_cli:adresse_cli}
            });
                $("#nom_cli").val("");
                $('#prenom_cli').val("");
                $('#cin_cli').val("");
