<%-- 
    Document   : impression_credit
    Created on : 03 août. 2018, 13:44:12
    Author     : K-LynG
--%>
...
<html>
    <head>
        <title>Impression liste credit</title>
    ...
    <body>
        <%
            ...
            File target = new File(application.getRealPath("print/Liste_produit.jasper"));
