          ...
          <div class="row purchace-popup">
            <div class="col-12">
              <span class="d-flex alifn-items-center">
                <h3>Liste des messages envoyer</h3>
              </span>
            </div>
          </div>
             <%
              ResultSet res = gest.getAllout();
              int i = 0;
          %>
            <div class="row">
                                ...
                                <thead>
                                    <tr>
                                        <th><b>Expéditeur</b></th>
                                         <th><b>Destintaire</b></th>
                                        <th><b>Corps du message</b></th>
                                        <th><b>Temps d'envoi</b></th>
...
<script>
    function getVal(nbVal) {
      ...
      var senttime = document.getElementById("senttime" + nbVal).value;

      document.getElementById("id").value = id;
      document.getElementById("sender").value = sender;
      document.getElementById("receiver").value = receiver;
      document.getElementById("msg").value = msg;
      document.getElementById("senttime").value = senttime;
     }
                        ...
                        function(isConfirm){
                            if (isConfirm) {
                             for(var i=0; i<donne_cocher.length; i++){
                                $.ajax({
                                url:  'suppr_msg_out.jsp',
                                type: 'post',
                                data: { id:donne_cocher[i] }, 
                                dataType: 'html',
                                success:function() { 
                                $("#tab_msg").load("liste_message_envoyer.jsp #tab_msg");
                                    $('.id').val("");
                                }
                            });
                          }
