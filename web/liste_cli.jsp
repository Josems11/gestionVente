  ...
  <script src="assets/js/jquery.jclock-1.2.0.js" type="text/javascript"></script> 
    <script type="text/javascript">
        $(function($) {
         ...
         function CtrlNom() {
              var test = document.client.nom_cli.value;
              var ConvMaj = test.toUpperCase();
              document.client.nom_cli.value = ConvMaj;
          }
          
          function CtrlPrenom() {
              var comm = document.client.prenom_cli.value;
              var x = 0;
              var y = 1;
              ...
              document.client.prenom_cli.value = prnm;
          }
          
          function CtrlAdresse() {
              var str = document.client.adresse_cli.value;
              var x = 0;
              var y = 1;
              ...
              document.client.adresse_cli.value = adrss;
          }

          function CtrlCIN() {
            var numcin = document.client.cin_cli.value;
              var val = numcin.substring(6, 7);
                if (val === "1" || val === "2") {
                  document.client.cin_cli.value = numcin.substring(0, 6) + numcin.substring(6, 7)+ " " + numcin.substring(7, 15);
                } else {
                  swal({
          ...
          function CtrlTel() {
            var numphon = document.client.tel_cli.value;
            var commc = numphon.substring(6, 7);
              if (commc === "2" || commc === "3" || commc === "4" || commc === "9") {
                document.client.tel_cli.value = numphon.substring(0, 6)+ "" +numphon.substring(6, 7) + "" + numphon.substring(7, 17);
        } else {
          swal({
                                        ...
                                        <tr>
                                             ...
                                             <td align="center">
                                                <label class="form-check-label">
                                                    <input class="form-check-input" type="checkbox" id="checkbox" name="checkbox<%=i%>" onclick="getVal(<%=i%>)" value="<%= res.getString("num_cli")%>">
              ...
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                        <!--cle primaire cache-->
                        <input type="hidden" class="num_cli form-control" id="num_cli"/>
                        <!--cle primaire cache-->
                         <div class="form-group row">
                            <label class="col-md-2 col-form-label">Nom</label>
                            <div class="col-md-10">
                                <input type="text" name="nom_cli" id="nom_cli" class="form-control nom_cli" onblur="CtrlNom(client)">
                            </div>
                        </div>
                         <div class="form-group row">
                            <label class="col-md-2 col-form-label">Prénom(s)</label>
                            <div class="col-md-10">
                                <input type="text" name="prenom_cli" id="prenom_cli" class="form-control prenom_cli"  onblur="CtrlPrenom(client)">
                            </div>
                        </div>
                       <div class="form-group row">
                            <label class="col-md-2 col-form-label">CIN</label>
                            <div class="col-md-10">
                                <input type="text" name="cin_cli" id="cin_cli" class="form-control cin_cli" data-inputmask='"mask": "999 999 999 999"' data-mask onblur="CtrlCIN(client)">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label">Téléphone</label>
                            <div class="col-md-10">
                                <input type="text" name="tel_cli" id="tel_cli" class="form-control tel_cli" data-inputmask='"mask": "+261 39 99 999 99"' data-mask onblur="CtrlTel(client)">
                            </div>
                        </div>
                       <div class="form-group row">
                            <label class="col-md-2 col-form-label">Adresse</label>
                            <div class="col-md-10">
                                <textarea type="text" name="adresse_cli" id="adresse_cli" class="form-control adresse_cli" onblur="CtrlAdresse(client)"></textarea>
                            </div>
                        </div>
...
<script>
 ...
 <script language="JavaScript" type="text/javascript">
    function impression() {
        document.location = "impression_client.jsp";
    }
 </script>
</body>
<script>
    $(document).ready(function(){
        $('form').delegate('input.nom_cli','keyup',function(){
    ...
    function getVal(nbVal) {
      ...
      var nom_cli = document.getElementById("nom_cli" + nbVal).value;
      var prenom_cli = document.getElementById("prenom_cli" + nbVal).value;
      var cin_cli = document.getElementById("cin_cli" + nbVal).value;
      var tel_cli = document.getElementById("tel_cli" + nbVal).value;
      var adresse_cli = document.getElementById("adresse_cli" + nbVal).value;

      document.getElementById("num_cli").value = num_cli;
      document.getElementById("nom_cli").value = nom_cli;
      document.getElementById("prenom_cli").value = prenom_cli;
      document.getElementById("cin_cli").value = cin_cli;
      document.getElementById("tel_cli").value = tel_cli;
      document.getElementById("adresse_cli").value = adresse_cli;
     }
    ...
    $("#btn_update").click(function () {
        ...
        var cin_cli = $('.cin_cli').val();
        var tel_cli = $('.tel_cli').val();
        var adresse_cli = $('.adresse_cli').val();
          swal({
                title: "",
        ...
        function(isConfirm){
            if (isConfirm) {
               $.post('modif_client.jsp?code=' + num_cli, {
                   num_cli: num_cli,
                   nom_cli: nom_cli,
               ...
               function() {
                   $("#tab_cli").load("liste_cli.jsp #tab_cli");
                   $('.num_cli').val("");
                   $('.nom_cli').val("");
                   $('.prenom_cli').val("");
                   $('.cin_cli').val("");
                        ...
                        function(isConfirm){
                            if (isConfirm) {
                             for(var i=0; i<donne_cocher.length; i++){
                                $.ajax({
                                url:  'suppr_client.jsp',
                                type: 'post',
                                data: { num_cli:donne_cocher[i] }, 
                                dataType: 'html',
                                success:function() { 
                                $("#tab_cli").load("liste_cli.jsp #tab_cli");
                                    $('.num_cli').val("");
